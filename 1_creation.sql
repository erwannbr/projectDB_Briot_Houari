...
CREATE TABLE Release_(
   ...
   FOREIGN KEY(release_upc_Parents_album) REFERENCES Release_(release_upc)
...
CREATE TABLE Track(
   ...
   FOREIGN KEY(release_upc) REFERENCES Release_(release_upc)
		ON delete cascade on update cascade
);
...
CREATE TABLE Concerts(
   ...
   FOREIGN KEY(tour_id) REFERENCES World_Tour(tour_id)
		ON delete cascade on update cascade,
...
CREATE TABLE Part_of(
   ...
   FOREIGN KEY(tracks_ISRC) REFERENCES Track(tracks_ISRC)
		ON delete cascade on update cascade,
...
CREATE TABLE Sells(
   ...
   FOREIGN KEY(merch_SKU) REFERENCES Merch(merch_SKU)
		ON delete cascade on update cascade,
   FOREIGN KEY(tour_id) REFERENCES World_Tour(tour_id)
		ON delete cascade on update cascade
);
...
CREATE TABLE are_invited(
   ...
   FOREIGN KEY(artiste_id) REFERENCES Artistes(artiste_id)
		ON delete cascade on update cascade,
   FOREIGN KEY(tour_id, concert_id) REFERENCES Concerts(tour_id, concert_id)
		ON delete cascade on update cascade
);
...
CREATE TABLE Analysed_by(
   ...
   FOREIGN KEY(tour_id, concert_id) REFERENCES Concerts(tour_id, concert_id)
		ON delete cascade on update cascade,
   FOREIGN KEY(demographic_id) REFERENCES Démographics(demographic_id)
		ON delete cascade on update cascade
);
